...
5. **Cheapest check first.** Order the work so the check that can skip the rest runs before anything expensive, as the crawler's [skip ladder](../../../../services/crawler/README.md#skip-ladder) does.
